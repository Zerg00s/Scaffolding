(function () {  
    ...
    formTemplate.BaseViewID = "DisplayForm";
    formTemplate.Templates.Fields = {
        Title: { DisplayForm: function(){ return "asd";}}
    };
    formTemplate.OnPreRender = function(ctx){ 
        return "hello";
    };
    formTemplate.OnPostRender = function(ctx){ 
        return "hello";
    };
    formTemplate.Templates.View = function(ctx){ 
        return "hello";
    };
    formTemplate.Templates.Item = function(ctx){ 
        return "hello";
    };
    //formTemplate.Templates.View = viewTemplate; 
    formTemplate.Templates.DisplayForm = displayFormTemplate;
    SPClientTemplates.TemplateManager.RegisterTemplateOverrides(formTemplate); 
  
})();  
  
function displayFormTemplate(ctx){
    return "<b>Hello!<b/>"
};
